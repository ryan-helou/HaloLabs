  ...
  return (
    <div className="rounded-2xl border border-line bg-surface p-5 shadow-card">
      ...
      <div className="space-y-2.5 text-sm text-ink-soft">
        ...
        <div className="flex items-center gap-2.5">
          <span className="h-2.5 w-2.5 rounded-full bg-chip ring-1 ring-line" />
          <span>
        ...
        <div className="flex items-center gap-2.5">
          <span className="rounded-full bg-clay-soft px-1.5 py-0.5 font-mono text-[10px] uppercase tracking-[0.08em] text-clay">
            Quick win
          </span>
